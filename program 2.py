...
def royal_flush(hand):
    ...
    criteria = 0
    while listnum <= 4:
        if(10 <= hand[listnum][0] <= 14):
            criteria += 1
        if(hand[listnum][1] == hand[0][1]):
            criteria += 1
        listnum += 1
    if criteria == 10:
        return True
...
def straight_flush(hand):
    ...
    listnum = 0
    while listnum <= 3:
        if(hand[listnum][0] + 1 == hand[listnum+1][0]):
            criteria += 1
        listnum += 1
    listnum = 0
    while listnum <= 4:
...
def four_of_a_kind(ranks):
    if(ranks[0] == ranks[1] == ranks[2] == ranks[3]):
        return True
    elif(ranks[1] == ranks[2] == ranks[3] == ranks[4]):
        return True
    else:
        return False
...
def full_house(ranks):
    if(ranks[0] == ranks[1] == ranks[2]) and (ranks[3] == ranks[4]):
        return True
    elif(ranks[1] == ranks[2] == ranks[3]) and (ranks[0] == ranks[4]):
        return True
    elif(ranks[2] == ranks[3] == ranks[4]) and (ranks[0] == ranks[1]):
        return True
    else:
        return False
...
def two_pair(ranks):
    ...
    while listnum <= 3:
        if(ranks[listnum] == ranks[listnum+1]):
            criteria += 1
        listnum += 1
